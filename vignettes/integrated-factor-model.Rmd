...
stan_data$scaled_in_config = c(factor_data, channel_data$scaled_in_config, 
...
stan_data$scaled_in_stan = c(factor_data, channel_data$scaled_in_stan, 
...
Now going to try with the full complement of channels:

```{r}

chan_names = colnames(weekly_clean_data)[3:24]
depvar_name = "total_sales"
config_dir = tempdir()

factor_data = generate_factor_stan_data(depvar_name, chan_names, num_trends = 5, estimate_nu = T, 
                                        zscore = T)
